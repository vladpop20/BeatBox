...
public class BeatBox {
	...
	public void buildGui() {
		...
		background.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10)); // Creates a margin between the edges of the panel and rest of components are placec. Like SetPadding in JavaFX

		checkboxList = new ArrayList<>();		
		Box buttonBox = new Box(BoxLayout.Y_AXIS);			// Creates the box that will hold the controll buttons
		
		JButton start = new JButton("Start");
		start.addActionListener(new MyStartListener());		// MyStartListener is the class that implements ActionListener interface
		buttonBox.add(start);
